...
function Enquiry() {
  return (
    <div>
            <div className="flex bg-[#183B83] text-white m-6  p-6 min-[800px]:m-10 min-[800px]:p-8 min-[1000px]:m-12 min-[1100px]:mx-20 min-[1000px]:p-10 rounded-3xl">
        <div className="">
          <h3 className="font-semibold  text-[3vw]  min-[500px]:text-[2.7vw] min-[800px]:text-[2.1vw] min-[1000px]:text-[1.3vw]">Inclusions</h3>
          ...
          <h3 className="font-semibold text-[3vw] min-[500px]:text-[2.7vw] min-[800px]:text-[2.1vw] min-[1000px]:text-[1.3vw]">Exclusions</h3>
